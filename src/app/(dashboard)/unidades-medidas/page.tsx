...
export default function UnidadesMedidaPage() {
  ...
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      ...
      // Si hay un dropdown abierto, solo cerrar si el clic fue fuera de ambos (desktop y mobile)
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Gestiona las unidades de medida del sistema</p>
        </div>
        {canEdit && (
          <button
            onClick={openCreate}
